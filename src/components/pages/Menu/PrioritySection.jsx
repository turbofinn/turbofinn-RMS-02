...
const priorities = [
    {
        title: "Today's",
        subtitle: "Special",
        gradient: "linear-gradient(to right, rgba(251, 235, 245, 1), rgba(255, 255, 255, 1))",
    ...
    },
    {
        title: "SPECIALTY",
        subtitle: "Premium",
        gradient: "linear-gradient(to right, rgba(254, 246, 233, 1), rgba(255, 255, 255, 1))",
    ...
    },
    {
        title: "Vegetarian",
        subtitle: "Premium",
        gradient: "linear-gradient(to right, rgba(240, 236, 251, 1), rgba(255, 255, 255, 1))",
    ...
    },
    {
        title: "NON-VEG",
        subtitle: "Premium",
        gradient: "linear-gradient(to right,  rgba(237, 248, 244, 1), rgba(255, 255, 255, 1))",
...
function PrioritySection() {
    ...
    return (
        <Container maxWidth="lg" sx={{ mt: { xs: 4, lg: 5 }, px: { xs: 2, lg: 3 } }}>
            <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>

                <Typography sx={{ fontWeight: 500, fontSize: { xs: "13px", lg: "16px" }, marginLeft: { lg: "35px" } }}>
                    YOUR PRIORITY
                </Typography>

                <Box component="span" sx={{ flexGrow: 0.8, height: "1px", background: "linear-gradient(to right, rgba(90, 90, 90, 0.47), rgba(255, 255, 255, 1))", marginLeft: { xs: "5px" } }} />
            </Box>
                    ...
                    <Grid item xs={6} md={3} key={index}>
                        <Paper sx={{ p: { xs: 1, lg: 2 }, background: priority.gradient, borderRadius: "13px", display: "flex", alignItems: "center", boxShadow: "none", height: { lg: "100px" } }}>
                            ...
                            <Box sx={{ flexGrow: 1 }}>
                                ...
                                <Typography variant="h6" sx={{ color: priority.titleColor, fontSize: { xs: "0.9rem", lg: "1.25rem" }, fontWeight: 800 }}>
                                    {priority.title}
                                </Typography>

                                <Typography variant="subtitle2" sx={{ color: priority.subtitleColor, fontSize: { xs: "0.75rem", lg: "1rem" }, fontWeight: 600 }}>
                                    {priority.subtitle}
                                </Typography>
                            </Box>
