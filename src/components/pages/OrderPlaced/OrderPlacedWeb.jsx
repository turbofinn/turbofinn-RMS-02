...
function OrderPlacedWeb() {
  ...
  return (
    <Box>
      <NavBar></NavBar>
      <SimpleHead title={"Orders Placed"} h="9.5rem"></SimpleHead>
      <Typography
        sx={{
          fontSize: "2.75rem",
          lineHeight: "62.5px",
      ...
      <Box
        ...
        <Box
          ...
          <div
            style={{
              background:
                "linear-gradient(to right,rgb(0, 0, 0),rgb(0, 0, 0),rgba(0, 0, 0, 0.95),rgba(255,255,255,1))",
              width: "70%",
              height: "1px",
            }}></div>
          <Box sx={{ width: "fit" }}>
          ...
          <Box sx={{ width: "72.5%" }}>
            {orderedDish.map((elem, i) => (
              <OrderPlacedCardWeb
                ...
                cps={elem.costPerServing}
                serving={elem.serving}></OrderPlacedCardWeb>
            ))}
          </Box>
          <Box
            sx={{
