...
const AddTocard = () => {
    return (
        <React.Fragment>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={8} style={{
                        ...
                        <Box style={{
                            ...
                            <Typography variant="p" style={{ fontSize: '13px', color: '#525252' }}>VEGETARIAN</Typography>
                        </Box>
                        <Typography variant="h6" style={{ fontWeight: 600, marginTop: '0.3rem' }}>Dal Bati Churma</Typography>
            ...
            <Box 
            style={{ maxWidth: '95%', marginLeft: 'auto', marginRight: 'auto', padding: '1rem', borderBottom: '1px solid #d1d1d1', borderLeft: '1px solid #d1d1d1', borderRight: '1px solid #d1d1d1', borderBottomLeftRadius: '1.5rem', borderBottomRightRadius: '1.5rem', marginTop: '-1rem', paddingTop: '2rem', display: 'flex', alignContent: 'center', justify: 'center', alignItems: 'center' }}>
                <Typography style={{ fontSize: '0.9rem', color: '#525252', marginRight: '0.5rem' }}>Customize Your Order</Typography>
