        ...
        <React.Fragment>
                ...
                <Box sx={style}>
                    ...
                    <Box style={{ textAlign: 'center', marginTop: '0rem', position: 'relative' }}>
                        <img src={profileImage} alt="logo" style={{ border: '0.6rem solid #40A0B5', borderRadius: '50%', padding: '0.4rem', width:'11rem'}} />

                        <img src={edit} alt="edit" style={{ position: 'absolute', bottom: '20%', width:'2rem', left:'62%', backgroundColor:'white', padding:'0.4rem', borderRadius:'35%', border:'1px solid #1F6857' }} />

                    </Box>

                    <table style={{ marginLeft: 'auto', marginRight: 'auto', width: '85%', padding: '0rem' }}>
