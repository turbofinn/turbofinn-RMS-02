...
function AddToMealWeb() {
  ...
  return (
    ...
    <Box sx={{ minHeight: "100vh", position: "relative" }}>
      ...
      <Box
        sx={{ width: "100%", height: "21rem", backgroundImage: `linear-gradient(rgba(0, 0, 0, 1), rgba(0, 0, 0, 0.150), rgba(0, 0, 0, 0), rgba(0, 0, 0, 0)), url(${meal})`, backgroundSize: "cover", backgroundPosition: "center", zIndex: "-1" }} >
        {/* Description list */}
