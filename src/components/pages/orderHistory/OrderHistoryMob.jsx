...
import OrderHistoryCard from "../../common/OrderHistoryCard/OrderHistoryCardMob";

function OrderHistory() {
  return (
    <Box>
      <SimpleHead title={"Order History"} ></SimpleHead>
      <Typography
        sx={{
          fontWeight: "700",
      ...
      <Box
        ...
        <div
          style={{
            background:
              "linear-gradient(to right,rgba(0, 0, 0, 0.7),rgba(90,90,90,0.1))",width:'20%',height:'1px'
          }}></div>
        <Box sx={{width:'fit' }}>
          <SortBy></SortBy>
        </Box>
