          ...
          <Box sx={{ position: "relative" }}>
            ...
            >
              ...
              >
                <Typography
                  variant="body2"
                  sx={{color: isVegetarian? "rgba(132, 255, 145, 1)": "red", mr: 1, fontSize: "20px", display: "flex", alignItems: "center"}}
                >
                  {isVegetarian ? "●" : "●"}
                  <text style={{color: "white", fontSize: "12px", fontWeight: 500}}>
                    {isVegetarian? "VEGETARIAN": "NON-VEGETARIAN"}</text>
                </Typography>
              </Box>
              <img
                src={line2}
                style={{width: "231px", height: "1px", display: "flex", justifyContent: "center", marginLeft: "3rem"}}/>
              
              <CardContent
                sx={{padding: "8px 16px", display: "flex", justifyContent: "space-between", alignItems: "center"}}>
                
                <Box
                  sx={{ position: "absolute", bottom: 10, left: 0, right: 0, display: "flex", justifyContent: "center", cursor: "pointer"}}
                  onClick={() => {
                    Navigate("/productdetails");}}>
                  
                  <Typography variant="button"
                    sx={{fontWeight: 600, color: "white", fontSize: "0.875rem"}}>
                    + ADD TO CART
                  </Typography>
                </Box>
              </CardContent>
